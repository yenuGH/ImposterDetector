...
public class Game {
    ...
    DONE - helper functions to get adjacent mines in mine column/row ex - getMinesadjacent(row,column)
    ...
    */
    ...
    /**
     * Scans a cell. If no mine is found it performs a scan. If a mine is found it reveals it. If a mine has already been revealed it scans.
     * @param row
     * @param column
     */
